...
const MAP_KEY = "AIzaSyDU68xXJtiOxBu5noq4egQpKUHkemmfrtw";
...
class MapDisplay extends Component {
    ...
    componentWillReceiveProps = (props) => {
        ...
        this.setState({firstDrop: false, introAnim, activeMarker: props.activeMarker, showingInfoWindow, venueCount: props.venues.length},
            () => {
                if (this.state.activeMarker) this.state.activeMarker.marker.setAnimation(this.props.google.maps.Animation.DROP);
            });
    }
